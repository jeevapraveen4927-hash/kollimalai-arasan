...
export default function MilletsPage() {
  const millets = getProductsByCategory("Millets");
      ...
      <section className="mx-auto max-w-[1200px] px-4 py-10">
        ...
        {millets.length === 0 ? (
          <div className="mt-10 rounded-xl border border-gray-200 py-16 text-center">
            <p className="text-base font-semibold text-gray-700">No millet products yet</p>
            <p className="mt-1 text-sm text-gray-500">
              Check back soon, or browse our{" "}
              <a href="/spices" className="font-medium text-brand-green hover:underline">
                Spices
              </a>{" "}
